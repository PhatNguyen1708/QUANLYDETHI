...
UPDATE DETHI SET THOIGIAN_BATDAU= null,SOCAUHOI= 2
UPDATE DETHI SET THOIGIAN_BATDAU='15-12-2024 7:45',SOCAUHOI= 2 where MADETHI = 'DT00003'

SELECT dethi.MADETHI,THOIGIAN_BATDAU, tenmonhoc
FROM DETHI, DETHI_MONHOC, monhoc
where dethi.MADETHI = DETHI_MONHOC.MADETHI and DETHI_MONHOC.MAMONHOC = monhoc.MAMONHOC
